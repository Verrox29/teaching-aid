...
> = {
  generate_challenge_questions: {
    ...
    template: [
      ...
      '',
      'Primary goal: generate 2 to 3 concise but challenging oral questions that test real understanding of the specific presentation/work this group submitted.',
      '',
      'Focus on:',
